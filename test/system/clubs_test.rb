...
class ClubsTest < ApplicationSystemTestCase
  ...
  test "creating a Club" do
    ...
    fill_in "Category", with: @club.category_id
    fill_in "Email", with: @club.email
    fill_in "Image", with: @club.image
    fill_in "Introduction", with: @club.introduction
    fill_in "Member", with: @club.member
    fill_in "Name", with: @club.name
    fill_in "Place", with: @club.place
    fill_in "Time", with: @club.time
